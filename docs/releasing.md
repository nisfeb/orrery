...
Orrery is a **stock desk app**: the source of truth is this git repo, the
...
never synced again. The desk page reported itself up to date. `/apps/orrery`
...
`/nex/orrery/app.hoon` compiled cleanly in 11.8s — and the instance stayed
